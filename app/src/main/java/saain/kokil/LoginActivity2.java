...
public class LoginActivity2 extends AppCompatActivity {
    ...
    private static final String LOGTAG = "Bitstream Login";
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                switch (action){
                    ...
                    case Constants.BroadcastMessages.UI_CONNECTION_ERROR:
                        Log.d(LOGTAG,"Connection Error in LoginActivity!");
                        showProgress(false);
                        mJidView.setError("Error Connecting to Server. Make sure that you are wearing clothes! We dont serve naked people.");
                        break;
    ...
    private void saveCredentialsAndLogin()
    {
        ...
        Log.d(LOGTAG,"Intent Starting.......");
        //Start the service
        Intent i1 = new Intent(this, BitstreamConnectionService.class);
        startService(i1);
